  ...
  <div class="container"> <a class="navbar-brand" href="index.html"><i class="flaticon-ADFM"></i>ADFM <br>
    ...
    <div class="collapse navbar-collapse" id="ftco-nav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item"><a href="https://www.mocatest.org/" class="nav-link">MoCA COGNITIVE ASSESSMENT</a></li>
        <li class="nav-item"><a href="patient_form.html" class="nav-link">NEW PATIENT</a></li>
